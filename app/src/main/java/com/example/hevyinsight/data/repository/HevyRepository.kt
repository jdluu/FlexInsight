...
class HevyRepository(
    database: HevyDatabase,
    private val apiKeyManager: ApiKeyManager,
    networkMonitor: com.example.hevyinsight.core.network.NetworkMonitor,
    cacheManager: com.example.hevyinsight.data.cache.CacheManager
) {
    private val workoutDao = database.workoutDao()
    private val exerciseDao = database.exerciseDao()
    private val setDao = database.setDao()
    
    private val apiClient = com.example.hevyinsight.data.api.HevyApiClient()
