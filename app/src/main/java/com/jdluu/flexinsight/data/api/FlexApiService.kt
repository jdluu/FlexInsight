...
import com.jdluu.flexinsight.data.model.CreateRoutineResponse
...
import com.jdluu.flexinsight.data.model.PaginatedExerciseTemplatesResponse
import com.jdluu.flexinsight.data.model.PaginatedRoutineResponse
import com.jdluu.flexinsight.data.model.PaginatedWorkoutResponse
...
interface FlexApiService {
    ...
    ): Response<com.jdluu.flexinsight.data.model.PaginatedWorkoutEventsResponse>
    ...
    suspend fun getRoutineFolders(
        @Query("page") page: Int = 1,
        @Query("pageSize") pageSize: Int = 50
    ): Response<com.jdluu.flexinsight.data.model.PaginatedRoutineFolderResponse>
}
